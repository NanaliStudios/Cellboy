...
//		case "Ads_SpecialUpgrade": value = IsPossible_ShowContent1; break;
//		case "Ads_Missile": 	   value = IsPossible_ShowContent2; break;
//		}
//		
//		return value;
//	}
//	
//	//동영상 광고 관련 CreatePlacement.
//	public void AdsContentsReady()
//	{
//		ContentsReady("Ads_SpecialUpgrade");
//		ContentsReady("Ads_Missile");
//	}
//	
...
//	public void ShowContents(string placement_key)
//	{
//		StartCoroutine(WaitForContentReady(placement_key));
//	}
//	
//	private IEnumerator WaitForContentReady(string key)
//	{
////		while(true)
////		{
////			if(IsReady(key))
////				break;
////			//			Debug.Log ("Wait for tapjoy ready setting : "+Time.time);
////			yield return new WaitForFixedUpdate();
////		}
//
//		yield return new WaitForFixedUpdate();
//		TJPlacement.CreatePlacement(key).ShowContent();
//	}
//	
//	//컨텐츠 대기상태 설정.
...
//		case "Ads_SpecialUpgrade": IsPossible_ShowContent1 = isReady; break;
//		case "Ads_Missile": 	   IsPossible_ShowContent2 = isReady; break;
//		}
//	}
//	
